...
class RunnerConfig:
    ...
    results_output_path: Path = ROOT_DIR / 'experiments_loops2_9onwopt'
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        factor5 = FactorModel("loop_type",['loop9_opt_fission', 'loop10_opt_cacheblocking', 'loop10_opt_unrolling', 'loop11_opt_cacheblocking', 'loop11_opt_prediction', 'loop12_opt_cacheblocking', 'loop12_opt_collapsing', 'loop12_opt_unrolling', 'loop13_opt_fusion', 'loop13_opt_recursionbreaking'])
