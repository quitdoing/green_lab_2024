...
class RunnerConfig:
    ...
    results_output_path: Path = ROOT_DIR / 'experiments_loops_no'
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        factor4 = FactorModel("optimization", ['no'])
        looplist = []
        for i in range(1, 11):  # From loop1 to loop10
            looplist.append(f"loop{i}")
