...
class RunnerConfig:
    ...
    results_output_path: Path = ROOT_DIR / 'experiments_loops2_14opt' 
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        factor5 = FactorModel("loop_type",['loop1_opt_cacheblocking', 'loop2_opt_batching', 'loop3_opt_batching', 'loop3_opt_cacheblocking', 'loop4_opt_batching'])
